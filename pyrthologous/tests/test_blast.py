...
class testBlast(TestCase):
    def setUp(self):
        ...
        self.blast_output = [
            b"".join([b"Protein_query\tProt2\t99.33\t300\t0\t2\t122",
                      b"\t420\t2\t300\t0.0\t 626"]),
            b"".join([b"Protein_query\tProt2\t21.88\t64\t30\t1\t74",
                      b"\t137\t175\t218\t1.8\t16.9"]),
	    b"".join([b"Protein_query\tProt2\t33.33\t18\t12\t0\t37",
                      b"\t54\t331\t348\t6.9\t15.4"])]
    ...
    def test_blastp(self):
        ...
        self.assertEqual(blast_stderr, b"")
